...
export default class ShowScanDetail extends Component {
    constructor(props) {
        super(props);
        this.camera = null;
        this.state = {
    ...
    //开灯关灯
    _changeFlash() {
        console.log(this.state.openFlash)
        this.setState({
                                        ...
                                        <View style={styles.titleContainer}>
                                            <View style={styles.leftContainer}>
                                                <TouchableOpacity activeOpacity={1} onPress={ this._goBack}>
                                                    <View>
                                                        <Image style={ styles.backImg } source={{uri:'navigationbar_arrow_up'}}/>
                                                    </View>
                                                </TouchableOpacity>
                                           </View>
                                        </View>
